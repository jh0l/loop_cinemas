import { Movie, Review, Session } from "../src/types/index.js";
...
/**
 * Generates a random set of sessions for a movie
 * @returns an array of sessions for the next 7 days
 */
export const genSessions = (movie_id: string) => {
  const res: Session[] = [];
  for (let i = 1; i <= 7; i++) {
    ...
    for (let j = 0; j < Math.floor(Math.random() * 5) + 1; j++) {
      ...
      const date_time = new Date(Date.now() + DAY * i);
      date_time.setHours(parseInt(hour));
      date_time.setMinutes(parseInt(minute));
      res.push({
        date_time,
        movie_id,
      } as Session);
...
export const MOVIES: Movie[] = [
  {
    ...
    year: "2023",
    content_rating: "R",
    poster_url: "Document2_htm_6e6a41119b9ce1f7",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG",
    poster_url: "Document2_htm_dd1a88e6d7d098ec",
  ...
  },
  {
    ...
    poster_url: "Document2_htm_7b57183b1c5f69f2",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "R",
    poster_url: "Document2_htm_c7b919c1465e06d4",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_c5e16bfb6dd9244a",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_a2487a2c3c6b1252",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_dcb5fd75f74dd4f2",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_bc207ccbc0b336f9",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_8fcfb0f1a877276a",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_bf0525e9b3fcfc24",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_9b1fa59041ab9bf8",
  ...
  },
  {
    ...
    year: "2022",
    content_rating: "PG-13",
    poster_url: "Document2_htm_f8285bbfcfdcf3a9",
  ...
  },
  {
    ...
    year: "2021",
    content_rating: "R",
    poster_url: "Document2_htm_ebaf0077598e0793",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_8da26b10c8ee3f84",
  ...
  },
  {
    ...
    year: "2022",
    content_rating: "PG-13",
    poster_url: "Document2_htm_a7d089f5a7976088",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG",
    poster_url: "Document2_htm_e7be8af70e120fb4",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "",
    poster_url: "Document2_htm_dd7acd6acbaffcda",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG",
    poster_url: "Document2_htm_fece228d667a3437",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "R",
    poster_url: "Document2_htm_5010027795b299e0",
    plot: "A group of adventurers embark on a quest to find a mythical treasure in a fantasy world inspired by the popular role-playing game.",
    genres: ["Action", "Adventure", "Fantasy"],
  },
  {
    ...
    year: "2023",
    content_rating: "PG",
    poster_url: "Document2_htm_2b539974f7523d78",
  ...
  },
  {
    ...
    year: "2022",
    content_rating: "PG-13",
    poster_url: "Document2_htm_301e4df0859d3b6d",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_2cad7cfe71404824",
  ...
  },
  {
    ...
    year: "2023",
    content_rating: "PG-13",
    poster_url: "Document2_htm_590ba89081100ef3",
